...
public class BooksPageProcessor_copy_1610142338 implements PageProcessor {
	private final static String SITE_DOMAIN = "http://china-pub.com/";
	// private final static String START_URL =
	// "http://product.china-pub.com/63237";
	// private final static String START_URL =
	// "http://product.china-pub.com/cache/browse2/31/2_1_31-01-05-10_0.html";
	private final static String START_URL = "http://www.china-pub.com/Browse/";
	...
	public static void main(String[] args) {
		...
		Spider.create(new BooksPageProcessor_copy_1610142338()).addUrl(START_URL)
				.setScheduler(new FileCacheQueueScheduler("Output/")
						.setDuplicateRemover(new BloomFilterDuplicateRemover(100000)))
				.addPipeline(new JsonFilePipeline(output.getAbsolutePath() + "/" + timestamp + "_JSON"))
				...
				.addPipeline(new FileDownloaderPipeline(output.getAbsolutePath() + "/" + "Covers"))
		...
		// test
		// Spider.create(new BooksPageProcessor()).addPipeline(new
		// ConsolePipeline()).test(START_URL);
	}
